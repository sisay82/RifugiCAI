...
import { BcFruitionRevision } from './fruition.component';
...
@NgModule({
    declarations: [BcFruitionRevision],
    exports: [BcFruitionRevision],
    imports: [BcCheckboxInputModule,
        BcIconModule,
        BcTextInputModule,
        BcSelectInputModule,
        BcDividerModule,
...
export class BcFruitionRevisionModule { }
